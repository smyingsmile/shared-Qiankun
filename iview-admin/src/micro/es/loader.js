    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_m) {
            ...
            case 0:
                let entry = app.entry
                appName = app.name;
                let _a = configuration.singular
                singular = _a === void 0 ? false : _a
                let _b = configuration.sandbox
                sandbox = _b === void 0 ? true : _b
                let importEntryOpts = __rest(configuration, ['singular', 'sandbox']);
                return [4,
                        /* yield */
            ...
            case 1:
                ...
                execScripts = _c.execScripts
                assetPublicPath = _c.assetPublicPath;
                return [4,
                        /* yield */
            ...
            case 4:
                ...
                let _d = _mergeWith({}, getAddOns(global, assetPublicPath), lifeCycles, function (v1, v2) {
                    return _concat(v1 !== null && v1 !== void 0 ? v1 : [], v2 !== null && v2 !== void 0 ? v2 : []);
                })
                let _e = _d.beforeUnmount
                beforeUnmount = _e === void 0 ? [] : _e
                let _f = _d.afterUnmount
                afterUnmount = _f === void 0 ? [] : _f
                let _g = _d.afterMount
                afterMount = _g === void 0 ? [] : _g
                let _h = _d.beforeMount
                beforeMount = _h === void 0 ? [] : _h
                let _j = _d.beforeLoad
                beforeLoad = _j === void 0 ? [] : _j;
                return [4,
                        /* yield */
            ...
            case 6:
                ...
                let _k = getLifecyclesFromExports(scriptExports, appName, global)
                bootstrap = _k.bootstrap
                mount = _k.mount
                unmount = _k.unmount
                update = _k.update;
                let _l = getMicroAppStateActions(appInstanceId)
                onGlobalStateChange = _l.onGlobalStateChange
                setGlobalState = _l.setGlobalState
                offGlobalStateChange = _l.offGlobalStateChange;
                parcelConfig = {
                    name: appInstanceId,
                    bootstrap: bootstrap,
                    mount: [function () {
